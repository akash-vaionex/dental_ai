...
export  function Footer() {
  return (
    <footer className="isolate relative ">
      
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8 ">
      <div
        className="absolute inset-x-0 top-0 -z-10 -translate-y-1/2 transform-gpu overflow-hidden opacity-30 blur-3xl"
        aria-hidden="true"
      >
        <div
        ...
        <div className="mt-10 flex justify-center space-x-10">
          {navigation.social.map((item) => (
            <Link key={item.name} href={item.href} className="text-gray-700 hover:text-gray-500">
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-700">
          &copy; 2023 DentalCare AI, Inc. All rights reserved.
        </p>
      </div>
      <div
